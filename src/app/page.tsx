      ...
      <main className='relative h-full w-full flex-1 overflow-auto transition-width'>
        <div role='presentation' className='flex h-full flex-col'>
          <div className='overflow-hidden lg:mx-auto lg:max-w-2xl xl:max-w-3xl p-2'>
            <p className='text-xl text-stone-400 font-semibold'>Chatbot</p>
          </div>
          <div className='flex-1 overflow-hidden lg:mx-auto lg:max-w-2xl xl:max-w-3xl'>
            <ChatContainer>
              <UserMessage text='What is a bot? DLskhjfldfah sdl fjkash dlfkjas hfljka sd hfla jkdfhal jkfhldjkfhs dklfj ashlfjk dlf jkahl fjashdlfjk ashlfjash' />
